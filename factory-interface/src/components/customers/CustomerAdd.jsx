...
const CustomerAdd = ({ setIsCustomerModalOpen, fetchCustomers }) => {
    ...
    return (
        <div dir='rtl' className='fixed inset-0 flex items-center justify-center z-50 p-4'
                ...
                <div className="sticky top-0 bg-gradient-to-r from-blue-600 to-blue-700 px-4 sm:px-6 py-4 z-10">
                    <div className="flex justify-between items-center">
                        <div className="flex items-center gap-3">
                            ...
                            <h2 className='text-white text-lg font-bold'>إضافة عميل جديد</h2>
                        </div>
                        <button
                            onClick={handleClose}
                    ...
                    <p className='text-blue-100 text-sm mt-2'>املأ البيانات الأساسية للعميل</p>
                </div>
                    ...
                    <form className='space-y-5' onSubmit={handleSubmit}>
                            ...
                            <div className='w-full sm:w-2/3'>
                                <div className='relative group'>
                                    <input
                                        ...
                                        disabled={isLoading}
                                    />
                                    <FiUser className="absolute right-3 top-1/2 transform -translate-y-1/2 text-blue-400" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div className='w-full sm:w-2/3'>
                                <div className='relative group'>
                                    <input
                                        ...
                                        disabled={isLoading}
                                    />
                                    <FiMail className="absolute right-3 top-1/2 transform -translate-y-1/2 text-blue-400" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div className='w-full sm:w-2/3'>
                                <div className='relative group'>
                                    <input
                                        ...
                                        disabled={isLoading}
                                    />
                                    <FiPhone className="absolute right-3 top-1/2 transform -translate-y-1/2 text-blue-400" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div className='w-full sm:w-2/3'>
                                <div className='relative group'>
                                    <input
                                        ...
                                        disabled={isLoading}
                                    />
                                    <FiMapPin className="absolute right-3 top-1/2 transform -translate-y-1/2 text-blue-400" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col sm:flex-row items-start sm:items-center gap-3'>
                            <div className='w-full sm:w-1/3'>
                                ...
                                <p className='text-blue-500 text-xs'>الرصيد الحالي للعميل (اختياري)</p>
                            </div>
                            <div className='w-full sm:w-2/3'>
                                <div className='relative group'>
                                    <input
                                ...
                                <p className='text-blue-500 text-xs mt-1'>
                                    اترك القيمة 0 إذا لم يكن للعميل رصيد مسبق
                                </p>
                            </div>
                        </div>
                ...
                <div className='px-4 sm:px-6 py-3 bg-blue-50 border-t border-blue-100'>
                    <div className='flex flex-wrap items-center gap-4 text-blue-600 text-xs'>
                        <div className='flex items-center gap-1'>
                            ...
                            <span>جميع الحصوص مطلوبة</span>
                        </div>
                        <div className='flex items-center gap-1'>
                            <div className='w-2 h-2 bg-blue-400 rounded-full'></div>
                            <span>سيتم حفظ البيانات في قاعدة البيانات</span>
                        </div>
                        <div className='flex items-center gap-1'>
                            <div className='w-2 h-2 bg-blue-400 rounded-full'></div>
                            <span>يمكن تعديل البيانات لاحقاً</span>
                        </div>
                    </div>
                </div>
            </motion.div>
