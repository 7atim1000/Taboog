...
const CustomerUpdate = ({ customer, setIsEditCustomerModal, fetchCustomers }) => {
    ...
    const onSubmitHandler = async (event) => {
        ...
        try {
            ...
            const { data } = await api.put(`/api/customer/${customer._id}`, updateData);

            if (data.success) {
                enqueueSnackbar('تم تعديل بيانات العميل بنجاح', { variant: "success" });
                fetchCustomers();
                handleClose();
            } else {
    ...
    return (
        <div className='fixed inset-0 flex items-center justify-center z-50 p-4'
            ...
            >
                ...
                <div className="sticky top-0 bg-gradient-to-r from-blue-600 to-blue-700 px-4 sm:px-6 py-4 z-10">
                    <div className="flex justify-between items-center">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className='text-white text-lg font-bold'>تعديل بيانات عميل</h2>
                                <p className='text-blue-100 text-sm'>{customer?.customerName}</p>
                            </div>
                        </div>
                        <button
                            onClick={handleClose}
                ...
                {/* Modal Body */}
                <div className="p-3 sm:p-5 overflow-y-auto max-h-[calc(90vh-120px)]">
                    <form className='space-y-5' onSubmit={onSubmitHandler}>
                        ...
                        <div className='flex flex-col sm:flex-row items-start sm:items-center gap-3'>
                            <div className='w-full sm:w-1/3'>
                                ...
                                <p className='text-blue-500 text-xs'>الاسم الكامل للعميل</p>
                            </div>
                            <div className='w-full sm:w-2/3'>
                                <div className='relative group'>
                                    <input
                                        ...
                                        disabled={isLoading}
                                    />
                                    <FiUser className="absolute right-3 top-1/2 transform -translate-y-1/2 
                                    text-blue-400" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div className='w-full sm:w-2/3'>
                                <div className='relative group'>
                                    <input
                                        ...
                                        disabled={isLoading}
                                    />
                                    <FiPhone className="absolute right-3 top-1/2 transform -translate-y-1/2 
                                    text-blue-400" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div className='w-full sm:w-2/3'>
                                <div className='relative group'>
                                    <input
                                        ...
                                        disabled={isLoading}
                                    />
                                    <FiMapPin className="absolute right-3 top-1/2 transform -translate-y-1/2 
                                    text-blue-400" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='flex flex-col sm:flex-row items-start sm:items-center gap-3'>
                            <div className='w-full sm:w-1/3'>
                                ...
                                <p className='text-blue-500 text-xs'>الرصيد المالي للعميل</p>
                            </div>
                            <div className='w-full sm:w-2/3'>
                                <div className='relative group'>
                                    <input
                                        ...
                                        disabled={isLoading}
                                    />
                                    <FiDollarSign className="absolute right-3 top-1/2 transform -translate-y-1/2 
                                    text-blue-400" />
                        ...
                        <div className='bg-blue-50 rounded-xl p-4 border-2 border-blue-200'>
                            ...
                            <div className='grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs'>
                                <div className='text-blue-600'>
                                    ...
                                    <span className='text-blue-900 font-semibold mr-2'> {customer?.customerName}</span>
                                </div>
                                <div className='text-blue-600'>
                                    <span className='font-medium'>الرصيد الحالي:</span> 
                                    <span className={`font-semibold mr-2 ${customer?.balance >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                                        {customer?.balance?.toFixed(2)} ر.ع
                                    </span>
                                </div>
                                <div className='text-blue-600'>
                                    <span className='font-medium'>البريد:</span> 
                                    <span className='text-blue-900 font-medium mr-2'>{customer?.email}</span>
                                </div>
                                <div className='text-blue-600'>
                                    <span className='font-medium'>الهاتف:</span> 
                                    <span className='text-blue-900 font-medium mr-2'>{customer?.contactNo}</span>
                                </div>
                            </div>
                        </div>
