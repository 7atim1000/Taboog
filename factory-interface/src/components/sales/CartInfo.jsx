...
const CartInfo = () => {
    ...
    // Calculate totals
    const totalItems = sortedSaleData.length;
    const totalQuantity = sortedSaleData.reduce((sum, item) => sum + item.quantity, 0);
    const totalPrice = sortedSaleData.reduce((sum, item) => sum + item.price, 0);
                ...
                <div className='flex items-center justify-between'>
                    <div className='flex items-center gap-3'>
                        ...
                        <div>
                            ...
                            <p className='text-blue-100 text-xs mt-1'>تفاصيل فاتورة البيع</p>
                        </div>
                    </div>
                ...
                {sortedSaleData.length === 0 ? (
                    <div className='flex flex-col items-center justify-center py-12 text-center'>
                        <div className='w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mb-4'>
                            <FaShoppingCart className="text-blue-500 w-8 h-8" />
                        </div>
                        <h3 className='text-gray-600 font-medium mb-2'>سلة المشتريات فارغة</h3>
                        <p className='text-gray-400 text-sm'>الرجاء اختيار منتج لإضافته إلى الفاتورة</p>
                    </div>
                ) : (
                    <div 
                ...
                <div className='bg-blue-50 border-t border-blue-100 p-3'>
                    <div className='flex items-start gap-2'>
                        ...
                        <p className='text-xs text-blue-600'>
                            يمكنك النقر على أيقونة الحذف لإزالة منتج من الفاتورة
                        </p>
                    </div>
                </div>
            )}
