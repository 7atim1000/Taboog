...
const DetailsModalSupplier = ({ setIsDetailsModal }) => {
    ...
    const handlePrint = () => {
        ...
        WinPrint.document.write(` 
            <html>
                <head>
                    <title>كشف حساب المورد - ${supplierData.supplierName}</title>
                    <style>
                        @media print {
                            @page { margin: 0; }
                ...
                <div className="sticky top-0 bg-gradient-to-r from-blue-600 to-blue-700 px-4 sm:px-6 py-4 z-10">
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-3">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className='text-white text-lg sm:text-xl font-bold'>كشف حساب الموردين</h2>
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-3">
                        ...
                        <div className="flex flex-col items-end">
                            ...
                            <div className={`text-xl font-bold ${supplierData.balance >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                                {supplierData.balance?.toFixed(2)} <span className="text-blue-700 text-sm">ر.ع</span>
                            </div>
                            <div className="text-blue-500 text-xs mt-1">
                                {supplierData.balance >= 0 ? 'رصيد دائن' : 'رصيد مدين'}
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="mt-4 pagination">
                            ...
                            bg-blue-50 rounded-xl border border-blue-200">
                                <div className="text-blue-700 text-sm">
                                    عرض <span className="font-bold text-blue-900">{supplierInvoices.length}</span> من أصل{' '}
